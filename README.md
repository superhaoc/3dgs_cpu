...
3.the already optimized version doesn't included in the repo because of tech patents :(, including GPU sorting/culling millions of quad via Compute Shader ,then rendering via IndirectDraw,  somewhat reducing the overdraw of the quad(trick), adaptive instancing. etc
﻿
﻿
