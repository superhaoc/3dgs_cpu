...
3.This repository does not include optimized versions because of tech patents, including GPU sorting millions of quad via IndirectDraw,  reducing the overdraw of the quad(trick), instancing. etc
﻿
