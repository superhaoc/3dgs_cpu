...
3.This repository does not include optimized versions because of tech patents, including GPU sorting millions of quad via Compute Shader ,then rendering via IndirectDraw,  somewhat reducing the overdraw of the quad(trick), adaptive instancing. etc
﻿
﻿
